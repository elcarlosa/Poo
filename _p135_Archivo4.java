...
public class _p135_Archivo4 {
    ...
    public static void grabarArchivo(String archivo, ArrayList<String> datos) throws IDException{
        BufferedWriter fdatos = new BufferedWriter(new FileWriter(new File(archivo)));
        for (String dato : datos)
                        fdatos.write(dato +"\n");
        fdatos.close();
    }
public static ArrayList<String> leerArchivo(String archivo) throws IDException{
